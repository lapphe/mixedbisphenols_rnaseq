...
ggsave(plot1, filename = "pup_bp_unionpheatmap.png", path = "./figures_tables/", dpi= 600, height = 2, width = 6 )
...
ggsave(plot2, filename = "pup_lg_unionpheatmap.png", path = "./figures_tables/", dpi= 600, height = 2, width = 6 )
