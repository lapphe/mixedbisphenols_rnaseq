...
#Pup prelimbic cortex deseq2 analysis and figures
...
#-----------------Load data -
brain_region <- "Prelimbic cortex"
brain_region_short <- "pl"
group <- "pup"
cts <- read.csv("./data/pup_pl_raw.csv", row.names=1, check.names=FALSE)
