...
#BP pilot damss RNAseq DEGs for 5 regions figure for unadjusted p val <.05
...
ggsave(ticktick, filename = "dam_bp_unionpheatmap.png", path = "./figures_tables/", dpi= 600, height = 2, width = 6 )
...
df%>%
  ...
  scale_y_discrete(labels = y_axis)+
  ggtitle("Differentially expressed genes for licking/grooming in damss")+
  theme_bw(base_size = 9)+
  theme(legend.position = c(-0.18,-0.04),
...
ggsave(ticktick2, filename = "dam_lg_unionpheatmap.png", path = "./figures_tables/", dpi= 600, height = 2, width = 6 )
